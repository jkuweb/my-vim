...
highlight StatusLine    guifg=Black   guibg=#aabbee gui=bold ctermfg=Black ctermbg=Brown  cterm=none
highlight StatusLineNC  guifg=#444444 guibg=#aaaaaa gui=none ctermfg=Black ctermbg=Brown  cterm=none
"if &t_Co == 256
...
call s:hibg("LineNr"    ,"#222222","Brown",80)
...
highlight TabLineSel    guifg=White guibg=Black ctermfg=White ctermbg=Brown
